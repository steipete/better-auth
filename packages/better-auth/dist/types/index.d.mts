import { h as BetterAuthPlugin, B as BetterAuthOptions, ad as InferFieldsInputClient, ab as InferFieldsOutput, U as User, S as Session, n as Auth } from '../shared/better-auth.BH8RNaDG.mjs';
export { D as Account, a as Adapter, N as AdapterInstance, L as AdapterSchemaCreation, x as AdditionalSessionFieldsInput, y as AdditionalSessionFieldsOutput, v as AdditionalUserFieldsInput, w as AdditionalUserFieldsOutput, p as AuthContext, g as AuthPluginSchema, Q as FilterActions, P as FilteredAPI, G as GenericEndpointContext, H as HookEndpointContext, Y as InferAPI, I as InferOptionSchema, i as InferPluginErrorCodes, z as InferPluginTypes, r as InferSession, X as InferSessionAPI, q as InferUser, M as Models, R as RateLimit, O as SecondaryStorage, V as Verification, J as Where, E as init } from '../shared/better-auth.BH8RNaDG.mjs';
import { BetterFetchOption, BetterFetchResponse, BetterFetch, BetterFetchPlugin } from '@better-fetch/fetch';
import { WritableAtom, Atom } from 'nanostores';
import { U as UnionToIntersection, H as HasRequiredKeys, d as Prettify, L as LiteralString, S as StripEmptyObjects } from '../shared/better-auth.D9UKno48.mjs';
