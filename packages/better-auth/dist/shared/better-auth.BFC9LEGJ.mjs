...
import { c as createAuthMiddleware, a as createAuthEndpoint, g as getSessionFromCtx, B as BASE_ERROR_CODES, s as sessionMiddleware, f as freshSessionMiddleware } from './better-auth.mTsIPbfk.mjs';
...
import { s as setSessionCookie, d as deleteSessionCookie } from './better-auth.XCSUfGli.mjs';
import { JWTExpired } from 'jose/errors';
import '@better-auth/utils/random';
import { l as logger, s as shouldPublishLog } from './better-auth.D-CMlTs_.mjs';
import { s as safeJSONParse } from './better-auth.DkAEG6hU.mjs';
...
export { dropbox as $, deleteUserCallback as A, listUserAccounts as B, linkSocialAccount as C, requestPasswordResetCallback as D, requestPasswordReset as E, forgetPasswordCallback as F, deleteUser as G, HIDE_METADATA as H, setPassword as I, changePassword as J, changeEmail as K, sendVerificationEmail as L, verifyEmail as M, resetPassword as N, forgetPassword as O, signInEmail as P, signOut as Q, callbackOAuth as R, signInSocial as S, sendVerificationEmailFn as T, socialProviders as U, socialProviderList as V, SocialProviderListEnum as W, apple as X, getApplePublicKey as Y, atlassian as Z, discord as _, createAuthorizationCodeRequest as a, facebook as a0, figma as a1, github as a2, linear as a3, linkedin as a4, gitlab as a5, google as a6, kick as a7, microsoft as a8, notion as a9, reddit as aa, roblox as ab, salesforce as ac, spotify as ad, tiktok as ae, twitch as af, twitter as ag, LANG as ah, vk as ai, zoom as aj, huggingface as ak, slack as al, kakao as am, naver as an, line as ao, paypal as ap, validateToken as b, createAuthorizationURL as c, createRefreshAccessTokenRequest as d, getOAuth2Tokens as e, encodeOAuthParameter as f, generateCodeChallenge as g, decryptOAuthToken as h, generateState as i, handleOAuthUserInfo as j, createEmailVerificationToken as k, originCheckMiddleware as l, error as m, ok as n, originCheck as o, parseState as p, accountInfo as q, refreshAccessToken as r, setTokenUtil as s, toAuthEndpoints as t, updateUser as u, validateAuthorizationCode as v, wildcardMatch as w, getAccessToken as x, refreshToken as y, unlinkAccount as z };
