...
const getMigration = require('./better-auth.WGkhpiIA.cjs');
const getTables = require('./better-auth.Bt_3DcBl.cjs');
require('zod/v4');
...
const socialProviders_index = require('./better-auth.Dg3Pwtlb.cjs');
...
const kyselyAdapter = require('./better-auth.BTCM34MQ.cjs');
