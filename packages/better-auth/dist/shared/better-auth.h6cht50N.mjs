import { MysqlDialect, PostgresDialect, MssqlDialect, Kysely } from 'kysely';
import { c as createAdapter } from './better-auth.CmpI7ghp.mjs';
...
const kyselyAdapter = (db, config) => createAdapter({
  config: {
    ...
    supportsDates: config?.supportsDates !== void 0 ? config.supportsDates : config?.type === "sqlite" || config?.type === "mssql" || !config?.type ? false : true,
    supportsJSON: false
  },
