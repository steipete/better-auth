...
import { a as LiteralUnion, L as LiteralString, D as DeepPartial, U as UnionToIntersection, S as StripEmptyObjects, d as Prettify, O as OmitId, P as PrettifyDeep, E as Expand } from './better-auth.D9UKno48.cjs';
import { b as OAuthProvider, S as SocialProviders, c as SocialProviderList, O as OAuth2Tokens, a as OAuth2UserInfo } from './better-auth.DcPaQ6CM.cjs';
...
type BetterAuthOptions = {
     ...
     */
    database?: PostgresPool | MysqlPool | Dialect | AdapterInstance | {
        dialect: Dialect;
...
declare const signInSocial: {
    ...
    options: {
        ...
        body: z.ZodObject<{
            ...
            provider: z.ZodType<"apple" | (string & {}) | "atlassian" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal", unknown, z.core.$ZodTypeInternals<"apple" | (string & {}) | "atlassian" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal", unknown>>;
        ...
        signInSocial: {
            ...
            options: {
                ...
                body: zod.ZodObject<{
                    ...
                    provider: zod.ZodType<"github" | "apple" | "atlassian" | "discord" | "facebook" | "figma" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown, zod_v4_core.$ZodTypeInternals<"github" | "apple" | "atlassian" | "discord" | "facebook" | "figma" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown>>;
        ...
        signInSocial: {
            ...
            options: {
                ...
                body: zod.ZodObject<{
                    ...
                    newUserCallbackURL: zod.ZodOptional<zod.ZodString>;
                    errorCallbackURL: zod.ZodOptional<zod.ZodString>;
                    provider: zod.ZodType<"apple" | (string & {}) | "atlassian" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal", unknown, zod_v4_core.$ZodTypeInternals<"apple" | (string & {}) | "atlassian" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal", unknown>>;
                    disableRedirect: zod.ZodOptional<zod.ZodBoolean>;
                    idToken: zod.ZodOptional<zod.ZodObject<{
                        token: zod.ZodString;
                        nonce: zod.ZodOptional<zod.ZodString>;
...
export { shouldPublishLog as $, init as E, levels as _, signOut as a$, createLogger as a3, logger as a4, createInternalAdapter as a6, createFieldAttribute as a9, createCookieGetter as aA, getCookies as aB, setCookieCache as aD, setSessionCookie as aE, deleteSessionCookie as aF, parseCookies as aG, getSessionCookie as aI, getCookieCache as aJ, parseSetCookieHeader as aK, setCookieToHeader as aL, getEndpoints as aM, router as aN, signInSocial as aO, signInEmail as aP, callbackOAuth as aQ, getSessionQuerySchema as aR, getSession as aS, getSessionFromCtx as aT, sessionMiddleware as aU, requestOnlySessionMiddleware as aV, freshSessionMiddleware as aW, listSessions as aX, revokeSession as aY, revokeSessions as aZ, revokeOtherSessions as a_, getAuthTables as ak, accountSchema as al, userSchema as am, sessionSchema as an, verificationSchema as ao, parseOutputData as ap, getAllFields as aq, parseUserOutput as ar, parseAccountOutput as as, parseSessionOutput as at, parseInputData as au, parseUserInput as av, parseAdditionalUserInput as aw, parseAccountInput as ax, parseSessionInput as ay, mergeSchema as az, requestPasswordReset as b0, forgetPassword as b1, requestPasswordResetCallback as b2, forgetPasswordCallback as b3, resetPassword as b4, createEmailVerificationToken as b5, sendVerificationEmailFn as b6, sendVerificationEmail as b7, verifyEmail as b8, updateUser as b9, changePassword as ba, setPassword as bb, deleteUser as bc, deleteUserCallback as bd, changeEmail as be, error as bf, ok as bg, signUpEmail as bh, listUserAccounts as bi, linkSocialAccount as bj, unlinkAccount as bk, getAccessToken as bl, refreshToken as bm, accountInfo as bn, originCheckMiddleware as bo, originCheck as bp, BASE_ERROR_CODES as f, createAuthMiddleware as j, createAuthEndpoint as k, optionsMiddleware as o, checkPassword as s, betterAuth as u };
export type { AdapterDebugLogs as A, BetterAuthOptions as B, CreateCustomAdapter as C, Account as D, FieldAttribute as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, Where as J, KyselyDatabaseType as K, AdapterSchemaCreation as L, Models as M, AdapterInstance as N, SecondaryStorage as O, FilteredAPI as P, FilterActions as Q, RateLimit as R, Session as S, TelemetryContext as T, User as U, Verification as V, WithJsDoc as W, InferSessionAPI as X, InferAPI as Y, LogLevel as Z, Adapter as a, Logger as a0, LogHandlerParams as a1, InternalLogger as a2, FieldType as a5, InternalAdapter as a7, FieldAttributeConfig as a8, BetterAuthCookies as aC, EligibleCookies as aH, InferValueType as aa, InferFieldsOutput as ab, InferFieldsInput as ac, InferFieldsInputClient as ad, FieldAttributeToObject as ae, InferAdditionalFieldsFromPluginOptions as af, PluginFieldAttribute as ag, InferFieldsFromPlugins as ah, InferFieldsFromOptions as ai, BetterAuthDbSchema as aj, AdapterConfig as b, CustomAdapter as c, CleanedWhere as d, AdapterTestDebugLogs as e, AuthPluginSchema as g, BetterAuthPlugin as h, InferPluginErrorCodes as i, AuthEndpoint as l, AuthMiddleware as m, Auth as n, AuthContext as p, InferUser as q, InferSession as r, TelemetryEvent as t, AdditionalUserFieldsInput as v, AdditionalUserFieldsOutput as w, AdditionalSessionFieldsInput as x, AdditionalSessionFieldsOutput as y, InferPluginTypes as z };
