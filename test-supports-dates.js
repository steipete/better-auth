...
try {
    ...
    const actualSupportsDatesPG = postgresInstance.config.supportsDates;
...
try {
    ...
    const actualSupportsDatesSQLite = sqliteInstance.config.supportsDates;
...
try {
    ...
    const actualSupportsDatesPGDefault = postgresDefaultInstance.config.supportsDates;
...
try {
    ...
    const actualSupportsDatesSQLiteDefault = sqliteDefaultInstance.config.supportsDates;
