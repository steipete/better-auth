...
export { O as OAuth2Tokens, a as OAuth2UserInfo, b as OAuthProvider, P as ProviderOptions } from './shared/better-auth.C7l4WiP6.cjs';
import 'kysely';
import 'zod';
...
declare function getTelemetryAuthConfig(options: BetterAuthOptions, context?: TelemetryContext): {
    ...
    account: {
        modelName: string | undefined;
        fields: Partial<Record<"scope" | "accessToken" | "refreshToken" | "accessTokenExpiresAt" | "refreshTokenExpiresAt" | "idToken" | "userId" | "createdAt" | "updatedAt" | "password" | "providerId" | "accountId", string>> | undefined;
